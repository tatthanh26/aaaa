...
public class ScheduleService {
    ...
    public Schedule setToScheduleEntity(ScheduleDTO scheduleDTO) {
        ...
        if (scheduleDTO.getPetIds() != null) {
            List<Pet> petList = scheduleDTO.getEmployeeIds().stream().map(id -> petRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("Not found!"))).collect(Collectors.toList());
